import { add, all, all1, and, and1, any, array, assign, assignOp, branch, branchOr, branches, chain, choice, choices, choose, collect, collectAs, collectTotal, collectTotalAs, compose, concat, concatAs, cond, condOf, count, countIf, counts, countsAs, cross, defaults, define, disjoint, disperse, divide, dropPrefix, dropSuffix, filter, find, findWith, flat, foldTraversalLens, foldl, foldr, forEach, forEachWith, fromFantasy, fromFantasyApplicative, fromFantasyMonad, get, getAs, getInverse, getLog, getter, ifElse, index, inverse, is, isDefined, isEmpty, iso, iterate, join, joinAs, joinIx, json, lazy, lens, log, mapIx, matches, maximum, maximumBy, mean, meanAs, minimum, minimumBy, modify, modifyAsync, modifyOp, multiply, none, normalize, or, orElse, partsOf, pick, pickIn, pointer, prefix, product, productAs, prop, props, propsOf, query, removable, remove, replace, replaces, required, reread, rewrite, satisfying, seemsArrayLike, select, selectAs, seq, set, setIx, setOp, setter, skipIx, slice, split, subset, subtract, suffix, sum, sumAs, tieIx, toFunction, transform, transformAsync, traverse, uncouple, unless, valueOr, when } from 'partial.lenses';
