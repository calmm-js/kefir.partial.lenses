...
export const add = liftRec(L.add)
...
export const divide = liftRec(L.divide)
...
export const multiply = liftRec(L.multiply)
export const negate = liftRec(L.negate)
...
export const subtract = liftRec(L.subtract)
