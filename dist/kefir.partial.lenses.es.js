import { add, all, and, any, array, assign, assignOp, branch, branchOr, branches, chain, choice, choices, choose, collect, collectAs, compose, concat, concatAs, cond, condOf, count, countIf, counts, countsAs, defaults, define, disjoint, divide, dropPrefix, dropSuffix, filter, find, findWith, flat, foldTraversalLens, foldl, foldr, forEach, forEachWith, get, getInverse, getLog, ifElse, iftes, index, inverse, is, isDefined, isEmpty, iso, join, joinAs, json, lazy, lens, log, matches, maximum, maximumBy, mean, meanAs, minimum, minimumBy, modify, modifyAsync, modifyOp, multiply, none, normalize, or, orElse, pick, pickIn, pointer, prefix, product, productAs, prop, props, propsOf, query, removable, remove, replace, replaces, required, reread, rewrite, satisfying, seemsArrayLike, select, selectAs, seq, set, setOp, setter, slice, split, subtract, suffix, sum, sumAs, toFunction, transform, transformAsync, traverse, uncouple, unless, valueOr, when } from 'partial.lenses';
