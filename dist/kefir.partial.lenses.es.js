...
export { Identity, IdentityAsync, Select, append, children, complement, elems, elemsTotal, entries, first, flatten, identity, indexed, keyed, keys, last, leafs, negate, optional, removeOp, reverse, singleton, uri, uriComponent, values, zero } from 'partial.lenses';
