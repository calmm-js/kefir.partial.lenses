import { add, all, and, any, array, assign, assignOp, branch, branchOr, branches, chain, choice, choices, choose, collect, collectAs, compose, concat, concatAs, cond, condOf, count, countIf, counts, countsAs, defaults, define, disjoint, divide, dropPrefix, dropSuffix, filter, find, findWith, flat, foldTraversalLens, foldl, foldr, forEach, forEachWith, get, getAs, getInverse, getLog, getter, ifElse, index, inverse, is, isDefined, isEmpty, iso, join, joinAs, joinIx, json, lazy, lens, log, mapIx, matches, maximum, maximumBy, mean, meanAs, minimum, minimumBy, modify, modifyAsync, modifyOp, multiply, none, normalize, or, orElse, pick, pickIn, pointer, prefix, product, productAs, prop, props, propsOf, query, removable, remove, replace, replaces, required, reread, rewrite, satisfying, seemsArrayLike, select, selectAs, seq, set, setIx, setOp, setter, skipIx, slice, split, subtract, suffix, sum, sumAs, tieIx, toFunction, transform, transformAsync, traverse, uncouple, unless, valueOr, when } from 'partial.lenses';
export { Identity, IdentityAsync, Select, append, children, complement, elems, elemsTotal, entries, first, flatten, identity, indexed, keyed, keys, last, leafs, multikeyed, negate, optional, querystring, removeOp, reverse, singleton, uri, uriComponent, values, zero } from 'partial.lenses';
